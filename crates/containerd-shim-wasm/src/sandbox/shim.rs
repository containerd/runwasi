...
use super::instance::{Engine, Instance, InstanceConfig, Nop, Wait};
...
struct InstanceData<T: Instance<E>, E: Engine> {
    instance: Option<T>,
    base: Option<Nop>,
